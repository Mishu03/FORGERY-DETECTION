...
public class SignatureVerificationResult extends DetectionResult {
    ...
    public double getPressurePatternScore() { return pressurePatternScore; }
    public void setPressurePatternScore(double pressurePatternScore) { this.pressurePatternScore = pressurePatternScore; }
    public double getStrokeConsistencyScore() { return strokeConsistencyScore; }
    public void setStrokeConsistencyScore(double strokeConsistencyScore) { this.strokeConsistencyScore = strokeConsistencyScore; }
}
